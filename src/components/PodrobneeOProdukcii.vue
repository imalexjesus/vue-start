<template>
	<article class="first-section uk-light">
		<section class="uk-section uk-container uk-text-center" uk-height-viewport="offset-top: true; offset-bottom: true;">
			<h1 >Подробнее о продукции</h1>

			<div class="uk-container uk-light">
				<!--region SLIDESHOW-->
				<div class="uk-position-relative uk-visible-toggle uk-dark" uk-slideshow="min-height: 300; max-height: 600; autoplay: true;">
					...
					<ul class="uk-slideshow-items uk-text-center">
						...
						<li class="uk-container">
							...
							<div class="uk-container uk-width-large uk-text-center uk-light" style="position: absolute;bottom: 40px;left: 0;right: 0;">
								<a class="uk-button uk-button-default uk-width-auto uk-margin-small-bottom " href="">Где купить?</a>
								<button class="uk-button uk-button-default uk-width-auto">Прочитать полную инструкцию</button>
							</div>
						</li>
						<!--Олефар-->
						<li class="uk-container">
							<h2 class="uk-text-warning">Олефар</h2>
							<div class="uk-flex uk-flex-center uk-flex-top uk-text-center">
							...
							<div class="uk-container uk-width-large uk-text-center" style="position: absolute;bottom: 40px;left: 0;right: 0;">
								<a class="uk-button uk-button-default uk-width-auto uk-margin-small-bottom" href="">Где купить?</a>
								<button class="uk-button uk-button-default uk-width-auto">Прочитать полную инструкцию</button>
							</div>
						</li>
						<!--Синорм-->
						<li class="uk-container">
							<h2 class="uk-text-warning">Синорм</h2>
							<div class="uk-flex uk-flex-center uk-flex-top uk-text-center">
